//---------------------------------------------------------------------------
//
// <copyright file="ZDNETDetailPage.xaml.cs" company="Microsoft">
...
{
    public sealed partial class ZDNETDetailPage : Page
    {
        private DataTransferManager _dataTransferManager;

        public ZDNETDetailPage()
        {
            this.ViewModel = DetailViewModel.CreateNew(Singleton<ZDNETConfig>.Instance);
