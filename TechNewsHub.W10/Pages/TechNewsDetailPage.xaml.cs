//---------------------------------------------------------------------------
//
// <copyright file="TechNewsDetailPage.xaml.cs" company="Microsoft">
...
{
    public sealed partial class TechNewsDetailPage : Page
    {
        private DataTransferManager _dataTransferManager;

        public TechNewsDetailPage()
        {
            this.ViewModel = DetailViewModel.CreateNew(Singleton<TechNewsConfig>.Instance);
