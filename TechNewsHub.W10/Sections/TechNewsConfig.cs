...
{
    public class TechNewsConfig : SectionConfigBase<RssSchema>
    {
		public override Func<Task<IEnumerable<RssSchema>>> LoadDataAsyncFunc
        {
            get
            {
                ...
                {
                    Url = new Uri("http://www.computerweekly.com/rss/Latest-IT-news.xml")
                };
        ...
        public override ListPageConfig<RssSchema> ListPage
        {
            get 
            {
                return new ListPageConfig<RssSchema>
                {
                    ...
                    ListNavigationInfo = NavigationInfo.FromPage("TechNewsListPage"),
                    ...
                    {
                        return NavigationInfo.FromPage("TechNewsDetailPage", true);
                    }
                };
            }
        }
