...
{
    public class TheVergeConfig : SectionConfigBase<RssSchema>
    {
		public override Func<Task<IEnumerable<RssSchema>>> LoadDataAsyncFunc
        {
            get
            {
                ...
                {
                    Url = new Uri("http://www.theverge.com/rss/group/breaking/index.xml")
                };
        ...
        public override ListPageConfig<RssSchema> ListPage
        {
            get 
            {
                return new ListPageConfig<RssSchema>
                {
                    ...
                    ListNavigationInfo = NavigationInfo.FromPage("TheVergeListPage"),
                    ...
                    {
                        return NavigationInfo.FromPage("TheVergeDetailPage", true);
                    }
                };
            }
        }
